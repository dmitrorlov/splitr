...
vi.mock('../../wailsjs/go/app/App', () => ({
  AddHost: vi.fn().mockResolvedValue({ ID: 1, Address: '192.168.1.1', Description: 'Test Host', CreatedAt: new Date().toISOString() }),
  AddNetwork: vi.fn().mockResolvedValue({ ID: 1, Name: 'test-network', CreatedAt: new Date().toISOString() }),
  AddNetworkHost: vi.fn().mockResolvedValue({ ID: 1, NetworkID: 1, Address: '192.168.1.1', Description: 'Test', CreatedAt: new Date().toISOString() }),
